    ...
    <>
      <nav className="relative z-20 w-full flex items-center justify-between md:justify-around px-6 md:px-8 py-5 backdrop-blur-md border-b bg-white text-black">
        ...
        <div className="hidden md:flex gap-8 text-sm font-medium">
          ...
          <a href="#" className="hover:text-blue-600">Culture</a>
          <a href="#" className="hover:text-blue-600">Culinary</a>
          <a href="#" className="hover:text-blue-600">UMKM</a>
      ...
      {/* SIDEBAR MENU */}
      <div
        className={`fixed top-0 right-0 h-full w-[260px] bg-white z-40 shadow-xl transform transition-transform duration-300 ${
